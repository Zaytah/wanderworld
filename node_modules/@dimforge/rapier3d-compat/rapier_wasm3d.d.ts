...
export interface InitOutput {
  ...
  readonly rawcolliderset_coVoxelPrimitiveGeometry: (a: number, b: number) => number;
  ...
  readonly rawshape_voxels: (a: number, b: number, c: number, d: number) => number;
  readonly rawshape_voxelsFromPoints: (a: number, b: number, c: number, d: number) => number;
